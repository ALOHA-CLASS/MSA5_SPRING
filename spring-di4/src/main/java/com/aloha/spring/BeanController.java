...
public class BeanController {
	...
	public String bean(Model model) {
		...
		ApplicationContext context = new AnnotationConfigApplicationContext("com.aloha.spring");
		...
		// XML 설정 파일로 컨텍스트 객체 생성
		// TODO: 경로지정 재확인
//		ApplicationContext context3 = new ClassPathXmlApplicationContext("root-context.xml");         
